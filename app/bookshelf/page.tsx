        ...
        <div className="space-y-12">
            <div className="space-y-4">
                ...
                <p className="text-lg text-gray-800 leading-relaxed">
                    Books I&apos;ve read, am reading, or want to read since 2024. Tracked via <a href="https://hardcover.app" target="_blank" className="underline decoration-1 underline-offset-4 hover:opacity-70">Hardcover</a> API.
                </p>
            </div>
